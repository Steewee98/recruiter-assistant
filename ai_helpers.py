...
def interpreta_query_ricerca(query: str) -> dict:
    ...
    prompt = (
        ...
        "  incluse varianti di seniority (senior/junior) e sinonimi italiano/inglese\n"
        "  (es. 'consulente finanziario' → 'consulente patrimoniale', 'private banker',\n"
        "  'promotore finanziario', 'wealth manager', 'financial advisor', 'senior financial advisor').\n"
        "  Da 3 a 6 titoli, dal più vicino al più lontano.\n"
